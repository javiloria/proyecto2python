"""
Django settings for gestorAppTG project.
...
SECRET_KEY = 'ebb&3syfgj-_9#b3w*+b3$onb=_i*p*j9yb&gu$vj++87(yg+%'
...
WSGI_APPLICATION = 'gestorAppTG.wsgi.application'
